...
//#include
//"/home/pnbell/Src_GraphAlignment/ESSENS-master/Core/Basic_IO/Format/Level0/structure_defs.hpp"
...
class GDV_functions
{
    ...
    void distance_signature(int node, A_Network network, vector<int>& dist_sig)
    {
        ...
        {
            cout << "Error in function distance_signature: input variable network is empty."
                 << endl;
        }
        return;
    }

    vector<OrbitMetric> orbit_filter(vector<OrbitMetric>& orbits, int nodes,
