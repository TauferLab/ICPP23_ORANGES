...
def main( xmlpath ):
    ...
    #xmlpath = '/data/gclab/anacin-n/anacin_results/message_race/msg_size_512/without_ninja/run_001/slices/slice_1.graphml'
    #xmlpath = '/home/pnbell/Src_GraphAlignment/backup_slices/slices/slice_2.graphml'
    
    filelist = xmlpath.split('/')
    filename = filelist[len(filelist)-1]
    #filename = xmlpath[-16:]
    #filename = filename.replace('\\','')
    #filename = filename.replace('/','')
    filename = filename.replace('.graphml','.txt')
    ...
    #run_list = 'C:/Users/lohit/Desktop/RA/Datasets/Naive-2/naive_reduce/system_quartz/n_procs_11/proc_placement_spread/msg_size_1'
    #run_list = '/data/gclab/anacin-n/anacin_results/message_race/msg_size_1'
    #slice_number = 4
