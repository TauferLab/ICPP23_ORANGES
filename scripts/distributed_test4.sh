...
#PBS -q prod
#PBS -A Veloc
#PBS -o output/oranges_gpu_distributed4_polaris.out
#PBS -e output/oranges_gpu_distributed4_polaris.err
...
echo $(sed "3q;d" $PBS_NODEFILE) >>   "./hostfile1"
echo $(sed "4q;d" $PBS_NODEFILE) >>   "./hostfile1"
echo $(sed "5q;d" $PBS_NODEFILE) >    "./hostfile2"
echo $(sed "6q;d" $PBS_NODEFILE) >>   "./hostfile2"
echo $(sed "7q;d" $PBS_NODEFILE) >>   "./hostfile2"
echo $(sed "8q;d" $PBS_NODEFILE) >>   "./hostfile2"
echo $(sed "9q;d" $PBS_NODEFILE) >    "./hostfile3"
echo $(sed "10q;d" $PBS_NODEFILE) >>  "./hostfile3"
echo $(sed "11q;d" $PBS_NODEFILE) >>  "./hostfile3"
echo $(sed "12q;d" $PBS_NODEFILE) >>  "./hostfile3"
echo $(sed "13q;d" $PBS_NODEFILE) >   "./hostfile4"
echo $(sed "14q;d" $PBS_NODEFILE) >>  "./hostfile4"
echo $(sed "15q;d" $PBS_NODEFILE) >>  "./hostfile4"
echo $(sed "16q;d" $PBS_NODEFILE) >>  "./hostfile4"
echo $(sed "17q;d" $PBS_NODEFILE) >   "./hostfile5"
echo $(sed "18q;d" $PBS_NODEFILE) >>  "./hostfile5"
echo $(sed "19q;d" $PBS_NODEFILE) >>  "./hostfile5"
echo $(sed "20q;d" $PBS_NODEFILE) >>  "./hostfile5"
